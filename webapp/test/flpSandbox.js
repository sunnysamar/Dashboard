		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dashboard",
									"targetURL": "#dsbcomzcdashboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dsbcomzcdashboard-display": {
								"semanticObject": "dsbcomzcdashboard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dsb.com.zcdashboard",
									"url": sap.ui.require.toUrl("dsb/com/zcdashboard")
								}
							}
						}
					}
